...
import { Ban, Calendar, Clock, BadgeIcon as IdCard, Phone, User, Scissors, Check, Flame } from "lucide-react"
...
const MasculineDefaultAgendamento = () => {
    ...
    <div className="relative">
      ...
      >
        <BarbeariaStep>
          <div className="flex flex-col items-center mb-6">
            ...
            <div className="flex items-center">
              ...
              <Flame className="mx-2" size={14} style={{ color: theme.colors.primary }} />
              <div className="h-[1px] w-8" style={{ backgroundColor: theme.colors.primary }}></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 pb-10">
            {list.map((item) => (
              <motion.div
                ...
                className={`cursor-pointer overflow-hidden shadow-lg relative border-l-4 ${
                  isSelecionado(item.id) ? "" : "border-transparent"
                }`}
                style={{
        ...
        <BarbeariaStep>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pb-10">
            <motion.div
              ...
              className={`cursor-pointer overflow-hidden shadow-lg relative flex flex-col items-center justify-center h-40 border-l-4 ${
                isBarbeiroSelecionado(0) ? "" : "border-transparent"
              }`}
              style={{
            ...
            {barbeiros.map((item) => (
              <motion.div
                ...
                className={`cursor-pointer overflow-hidden shadow-lg relative border-l-4 ${
                  isBarbeiroSelecionado(item.id) ? "" : "border-transparent"
                }`}
                style={{
                  backgroundColor: theme.colors.cardBackground,
                ...
                <div className="flex flex-col mt-6">
                  ...
                  <div className="grid grid-cols-4 sm:grid-cols-5 gap-4">
                    {[
                      ...
                      <motion.div
                        key={time}
                        className={`text-center py-2 px-1 rounded-md cursor-pointer border-l-2 ${
        ...
        <BarbeariaStep>
          ...
          <div
            className="rounded-lg p-6 space-y-6 pb-10 border-l-4"
            style={{
              backgroundColor: theme.colors.cardBackgroundSecondary,
              ...
              {novo?.servicos && novo?.servicos?.length > 0 ? (
                <div className="space-y-2">
                  {novo?.servicos?.map((item) => (
                    <div
                      key={item.id}
                      className="flex justify-between items-center p-3 rounded border-l-2"
                      style={{
                        backgroundColor: theme.colors.cardBackground,
                        borderColor: theme.colors.primary,
                        borderRadius: theme.borderRadius.small,
            ...
            <div>
              ...
              <div className="space-y-2 pl-6">
                ...
                <div className="flex flex-wrap gap-4 mt-3">
                  <div
                    className="p-3 rounded flex items-center border-l-2"
                    style={{
                      backgroundColor: theme.colors.cardBackground,
                      borderColor: theme.colors.primary,
                      borderRadius: theme.borderRadius.small,
...
export default MasculineDefaultAgendamento
