...
export default function MasculineDefaultProdutos() {
  ...
  const productTemplate = (product: Product) => {
    ...
    return (
      <motion.div
        className="rounded-lg shadow-lg p-4 m-2 relative overflow-hidden border-l-4"
        style={{
  ...
  return (
    <div className="relative">
      ...
      <div className="flex flex-col items-center justify-center p-4 mt-8">
        <motion.button
          className="px-6 py-3 rounded-md font-medium transition-all duration-300 flex items-center gap-2 border-l-4"
          style={{
            backgroundColor: theme.colors.primary,
            color: "white",
            borderColor: theme.colors.primary,
