...
import { Ban, Calendar, Clock, BadgeIcon as IdCard, Phone, User, Scissors, Check, Hexagon } from "lucide-react"
...
const MasculinoModernoAgendamento = () => {
    ...
    <div className="relative">
      ...
      >
        <BarbeariaStep>
          <div className="flex flex-col items-center mb-6">
            ...
            <div className="flex items-center">
              <div className="h-[1px] w-8" style={{ backgroundColor: theme.colors.accent }}></div>
              <Hexagon className="mx-2" size={14} style={{ color: theme.colors.accent }} />
              <div className="h-[1px] w-8" style={{ backgroundColor: theme.colors.accent }}></div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 pb-10">
            {list.map((item) => (
              <motion.div
                ...
                className={`cursor-pointer overflow-hidden shadow-lg relative`}
                style={{
                  backgroundColor: theme.colors.primary,
                  borderRadius: theme.borderRadius.medium,
                  outline: isSelecionado(item.id) ? `2px solid ${theme.colors.accent}` : "none",
                  outlineOffset: isSelecionado(item.id) ? "2px" : "0",
                }}
                ...
                <div className="relative h-40">
                  ...
                  <div className="absolute bottom-0 left-0 p-3">
                    ...
                    <p
                      ...
                      style={{ color: isSelecionado(item.id) ? theme.colors.accent : "white" }}
                    >
        ...
        <BarbeariaStep>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pb-10">
            <motion.div
              ...
              className={`cursor-pointer overflow-hidden shadow-lg relative flex flex-col items-center justify-center h-40`}
              style={{
                backgroundColor: theme.colors.secondary,
                borderRadius: theme.borderRadius.medium,
                outline: isBarbeiroSelecionado(0) ? `2px solid ${theme.colors.accent}` : "none",
                outlineOffset: isBarbeiroSelecionado(0) ? "2px" : "0",
              }}
              whileHover={{ y: -5, transition: { duration: 0.3 } }}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {barbeiros.map((item) => (
              <motion.div
                ...
                style={{
                  backgroundColor: theme.colors.primary,
                  borderRadius: theme.borderRadius.medium,
                  outline: isBarbeiroSelecionado(item.id) ? `2px solid ${theme.colors.accent}` : "none",
                  outlineOffset: isBarbeiroSelecionado(item.id) ? "2px" : "0",
                }}
                whileHover={{ y: -5, transition: { duration: 0.3 } }}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              {novo.dataAgendamento && (
                <div className="flex flex-col mt-6">
                  <div className="flex flex-col items-center mb-6">
                    <div className="flex items-center">
                      <div className="h-[1px] w-8" style={{ backgroundColor: theme.colors.accent }}></div>
                      <Clock className="mx-2" size={14} style={{ color: theme.colors.accent }} />
                      <div className="h-[1px] w-8" style={{ backgroundColor: theme.colors.accent }}></div>
                    </div>
                    <p className="text-sm mt-2" style={{ color: theme.colors.textSecondary }}>
                      Selecione o horário
        ...
        <BarbeariaStep>
          ...
          <div
            className="rounded-lg p-6 space-y-6 pb-10"
            style={{
              backgroundColor: theme.colors.primary,
              borderRadius: theme.borderRadius.medium,
            }}
          >
            <div>
              <h4 className="text-lg font-semibold mb-3 flex items-center" style={{ color: theme.colors.text }}>
                <User size={18} className="mr-2" style={{ color: theme.colors.accent }} />
                Dados do Cliente
              </h4>
            ...
            <div>
              <h4 className="text-lg font-semibold mb-3 flex items-center" style={{ color: theme.colors.text }}>
                <Scissors size={18} className="mr-2" style={{ color: theme.colors.accent }} />
            ...
            <div>
              ...
              <div className="space-y-2 pl-6">
                ...
                <div className="flex flex-wrap gap-4 mt-3">
                  ...
                  >
                    <Clock size={18} className="mr-2" style={{ color: theme.colors.accent }} />
                    <span style={{ color: theme.colors.text }}>
...
export default MasculinoModernoAgendamento
